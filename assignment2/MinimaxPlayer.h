...
public:
    ...
    void minimax(OthelloBoard* b, int& col, int& row);
    int get_Utility(OthelloBoard *b);
    std::vector<OthelloBoard*> get_Successors(char symbol, OthelloBoard *b);
    int minimumPlayer(OthelloBoard* b);
    int maximumPlayer(OthelloBoard* b);
    /**
